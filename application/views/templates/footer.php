...
<a class="scroll-to-top rounded" href="#page-astop">
...
<script>     
	$('.custom-file-input').on('change', function() {         let fileName = $(this).val().split('\\').pop();         $(this).next('.custom-filelabel').addClass("selected").html(fileName);     }); 
